...
const P = preload("res://pbtest3.gd")
...
func exec(save_to_file, test_names):
	...
	for test_name in test_names:
		...
		if save_to_file:
			var out_file_name = "res://testout3/" + test_name[FUNC_NAME] + ".v3godobuf";
		...
		var erl_file_path = "res://testout3/" + test_name[FUNC_NAME] + ".v3ref";
		var erl_rv = null
